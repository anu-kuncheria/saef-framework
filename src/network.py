...
class Network:
    ...
    def load_network(self):
        ...
        gdf_links = gpd.GeoDataFrame(links, geometry=links.geometry, crs=self.crs)
    ...
    def process_links(self, boundary_file, newclass_path, write_directory, city_name):
        if boundary_file != '':
            ...
            print(f"==== Loading the boundary and links file for {city_name} ====")
            ...
            city_links = city_links.merge(link_chr, left_on='LINK_ID', right_on='LINK_ID', how='left')
            # export data
